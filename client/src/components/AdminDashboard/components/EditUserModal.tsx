      ...
      <div className="modal">
        ...
        <form onSubmit={onSubmit} className="modal-form user-form">
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              <label htmlFor="edit-phone-country-code">Country Code:</label>
              <select
          ...
          {createUserData.role === 'student' && (
            <>
              <div className="form-section">
                ...
                <div className="form-group">
                  <label htmlFor="edit-entryNumber">Entry Number:</label>
                  <input
                    type="text"
                    id="edit-entryNumber"
                    name="entryNumber"
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  <label htmlFor="edit-hostel-name">Select Hostel:</label>
                  <select
                    id="edit-hostel-name"
                ...
                <div className="form-group">
                  <label htmlFor="edit-hostel-room">Room Number:</label>
                  <input
                    type="text"
                    id="edit-hostel-room"
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  <label htmlFor="edit-emergency-address">Emergency Contact Address:</label>
                  <textarea
                ...
                <div className="form-group">
                  <label htmlFor="edit-emergency-additional-phone">Additional Phone (Optional):</label>
                  <input
                    type="tel"
                    id="edit-emergency-additional-phone"
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  <label htmlFor="edit-disabilityType">Disability Type:</label>
                  <select
                    id="edit-disabilityType"
                    name="disabilityType"
                ...
                <div className="form-group">
                  <label htmlFor="edit-udidNumber">UDID Number:</label>
                  <input
                    type="text"
                    id="edit-udidNumber"
                    name="udidNumber"
                ...
                <div className="form-group">
                  <label htmlFor="edit-disabilityPercentage">Disability Percentage:</label>
                  <input
                    type="number"
                    id="edit-disabilityPercentage"
          ...
          <div className="modal-actions">
            ...
            <button type="submit">
              Update {createUserData.role === 'admin' ? 'Admin' : createUserData.role === 'staff' ? 'Staff' : createUserData.role === 'student' ? 'Student' : 'Driver'}
            </button>
          </div>
        </form>
      </div>
