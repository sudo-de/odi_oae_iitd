...
export type FfiConsumerFunctions = {
    ...
    pactffiGetAsyncMessageRequestContents(pact: FfiPactHandle, messageCount: number, messageIndex: number): Buffer;
    pactffiGetSyncMessageRequestContents(pact: FfiPactHandle, messageCount: number, messageIndex: number): Buffer;
    pactffiGetSyncMessageResponseContents(pact: FfiPactHandle, messageCount: number, messageIndex: number): Buffer[];
};
