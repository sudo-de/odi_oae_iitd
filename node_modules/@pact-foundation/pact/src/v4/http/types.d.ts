...
import { Matcher, Path, SpecificationVersion, TemplateHeaders, TemplateQuery, V3MockServer, V3ProviderState, V3Request, V3Response } from '../../v3';
...
export type V4PluginRequestBuilderFunc = (builder: V4RequestWithPluginBuilder) => void;
export type V4PluginResponseBuilderFunc = (builder: V4ResponseWithPluginBuilder) => void;
